package kz.baltabayev.event.listener.extension;
...
/**
 * kz.baltabayev.event.listener.extension.CustomEventListenerProvider is a class that implements the EventListenerProvider interface from Keycloak.
...
public class CustomEventListenerProvider implements EventListenerProvider {
  ...
  /**
   * Constructor for the kz.baltabayev.event.listener.extension.CustomEventListenerProvider.
  ...
  public CustomEventListenerProvider(Producer<String, AuditEvent> producer) {
    ...
    log.info("kz.baltabayev.event.listener.extension.CustomEventListenerProvider created");
  }
