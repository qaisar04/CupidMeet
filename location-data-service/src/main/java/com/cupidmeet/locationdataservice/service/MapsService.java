...
public interface MapsService {
     ...
     * указано, что не найдено ни одного совпадения (totalResultsCount равен 0), метод ничего не делает
     * при удачном исходе. В противном случае метод выбрасывает exception.
     *
