...
public class UserPreferenceRequest {
    ...
    @NotBlank(message = "Предпочитаемый пол пользователя не может быть пустым")
    @Schema(description = "Предпочитаемый пол пользователя")
    private PreferredGender preferredGender;

    @NotBlank(message = "Минимальный предпочитаемый возвраст не может быть пустым")
    ...
    @NotBlank(message = "Максимальный предпочитаемый возвраст не может быть пустым")
